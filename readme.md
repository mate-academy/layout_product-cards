...
Create a pages with product card using `flexbox`, `BEM` and `SCSS` based on [this mockup](npm run lint).
...
- [DEMO LINK](https://kubakosidlo.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://kubakosidlo.github.io/layout_product-cards/report/html_report/)
