...
Create a page with product card using `flexbox`, `BEM` and `SCSS` based on [this mockup](https://www.figma.com/design/ojkArVazq7vsX0nbpn9CxZ/Moyo---Catalog--ENG-?node-id=11325-2287&p=f&t=ajjC7r3w3ddwWaNu-0).
...
- [DEMO LINK](https://oksanasht.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://oksanasht.github.io/layout_product-cards/report/html_report/)
