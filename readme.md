...
- [DEMO LINK](https://maksym-didyk.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://maksym-didyk.github.io/layout_product-cards/report/html_report/)
...
## The task
Create a pages with product card using `flexbox` basing on [the mockup](https://www.figma.com/file/ojkArVazq7vsX0nbpn9CxZ/Moyo--Catalog-(ENG)?node-id=11325%3A2287).
