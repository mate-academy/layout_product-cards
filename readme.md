...
Create a page with product card using `flexbox`, `BEM` and `SCSS` based on [this mockup](https://www.figma.com/file/ojkArVazq7vsX0nbpn9CxZ/Moyo-%2F-Catalog-(ENG)?httpsnode-id=11325%3A2287&mode=dev).
...
- [DEMO LINK](://MartaKurdylo.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://MartaKurdylo.github.io/layout_product-cards/report/html_report/)
