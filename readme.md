...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://VladyslavYarmolenko.github.io/layout_product-cards/) <br>
    - [TEST REPORT LINK](https://VladyslavYarmolenko.github.io/layout_product-cards/report/html_report/)
...
- card width is `200px` without border
