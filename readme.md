...
- [DEMO LINK](https://yevhenkharko.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://yevhenkharko.github.io/layout_product-cards/report/html_report/)
...
Create a pages with product card using `flexbox` basing on [the mockup](https://www.figma.com/file/ojkArVazq7vsX0nbpn9CxZ/Moyo-%2F-Catalog-(ENG)?type=design&node-id=11325-2287&mode=design&t=EdpkIrrKbAglCW36-0).
