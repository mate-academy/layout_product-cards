...
- [x] reset the browser's default margins
...
- [x]`background-image: url()` should be relative to the `index.scss`. So it should start with `../images`.
- [x]Rewrite the `stars` block from the [Stars task](https://github.com/mate-academy/layout_stars) with SCSS and use it
...
- [DEMO LINK](https://Ivanna-Fedor.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://Ivanna-Fedor.github.io/layout_product-cards/report/html_report/)
