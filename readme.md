...
- [DEMO LINK](https://xXPaRaZorXx.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://xXPaRaZorXx.github.io/layout_product-cards/report/html_report/)
...
Create a pages with product card using `flexbox` basing on [the mockup](npm).
