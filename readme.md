...
❗️ Replace `<yor_account>` with your GitHub username and copy the links to the `Pull Request` description:

- [DEMO LINK](https://mariiavoly.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://mariiavoly.github.io/layout_product-cards/report/html_report/)
