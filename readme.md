...
- `background-image: url()` should be relative to the `index`. So it should start with `../images`.
...
*Important note*: In this task, you are allowed to link `*` files directly in HTML `<link>` tags using `href` attribute.
...
- [DEMO LINK](https://denys-venzyk.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://denys-venzyk.github.io/layout_product-cards/report/html_report/)
