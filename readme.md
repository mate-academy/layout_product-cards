...
Create a pages with product card using `flexbox`, `BEM` and `SCSS` based on [this mockup](https://www.figma.com/file/ojkArVazq7vsX0nbpn9CxZ/Moyo-Catalog-(ENG)?node-id=11325%3A2287&mode=dev).
...
- [DEMO LINK](https://TetianaBukhenko.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://TetianaBukhenko.github.io/layout_product-cards/report/html_report/)
