...
- [DEMO LINK](https://Vladqwe.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://Vladqwe.github.io/layout_product-cards/report/html_report/)
...
## The task
Create a pages with product card using `flexbox` basing on [the mockup](https://www.figma.com/file/ojkArVazq7vsX0nbpn9CxZ/Moyo-%2F-Catalog-(ENG)?node-id=11325%3A2287&t=bgwDZcDeYmM7ciuz-0).
