...
❗️ Replace `Detek-tor` with your GitHub username and copy the links to the `Pull Request` description:

- [DEMO LINK](https://Detek-tor.github.io/layout_product-cards/)
- [TEST REPORT LINK](https://Detek-tor.github.io/layout_product-cards/report/html_report/)
